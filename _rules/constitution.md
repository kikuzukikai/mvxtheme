...
## 第4条(入退会と会員)
本会の正会員として入会しようとする者は、正会員2名以上の推薦を受け、連絡会の承認を経て入会することができる。
...
本会の賛助会員として入会しようとする者は、本会の[入会フォーム](https://join.kikuzukikai.org)より当該プランに登録することで入会することができる。

また、全ての会員は、本会の[設立趣意書]({{ "/blog/prospectus.html" | relative_url }})に賛同し、会の維持発展に必ず努めること。

正会員は、退会の旨を連絡会に届け出ることで任意に退会することができる。

賛助会員は、入会フォームの当該プランをキャンセルすることで任意に退会することができる。
